...
{% qnimg Network/Hardware/switch-router/collision-domain-hub.png %}
...
{% qnimg Network/Hardware/switch-router/collision-domain-switch.png %}
...
{% qnimg Network/Hardware/switch-router/broadcast-domain-router.png %}
